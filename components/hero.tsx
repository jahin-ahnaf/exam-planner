export default function Hero() {
  return (
    <section className="flex flex-col items-center justify-center text-white px-6 -mt-10 md:mt-10">
      <div className="text-center max-w-2xl dark:bg-zinc-800 p-10 md:pl-36 md:pr-36 rounded-2xl shadow-lg">
        <h1 className="text-3xl md:text-4xl font-bold dark:text-white text-black">Study Planner</h1>
        <p className="text-md md:text-lg dark:text-gray-300 mt-2 text-zinc-500">
        ...
        <div className="mt-10 items-center justify-items-center">
